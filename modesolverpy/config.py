...
2. ~/.config/modesolverpy.yml specific for the machine
...
home_config = home / ".config" / "modesolverpy.yml"
...
CONFIG["cache"] = pathlib.Path(
    CONFIG.get("cache", home / ".local" / "cache" / "modesolverpy")
)
